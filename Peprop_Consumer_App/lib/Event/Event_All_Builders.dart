...
class Event_All_Builders extends StatefulWidget{
  late List<Builder_Model> builder_details;
  Event_All_Builders(List<Builder_Model> builder_details){
...
class Build_State extends State<Event_All_Builders>{
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppUtils.appBarTitle(context, "Participating Builders"),
      body: Stack(
        children: [
                        ...
                        Expanded(child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:widget.builder_details[i].builder_logo.toString(),
