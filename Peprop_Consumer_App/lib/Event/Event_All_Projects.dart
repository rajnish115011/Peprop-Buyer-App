...
class Event_All_Projects extends StatefulWidget{
  late List<Prop_Model> builder_details;
  Event_All_Projects(List<Prop_Model> builder_details){
...
class Build_State extends State<Event_All_Projects>{
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppUtils.appBarTitle(context, "Participating Projects"),
      body: Stack(
        children: [
                        ...
                        Expanded(child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:widget.builder_details[i].property_logo.toString(),
