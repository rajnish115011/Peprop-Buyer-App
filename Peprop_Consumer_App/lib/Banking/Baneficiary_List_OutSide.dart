...
class Baneficiary_List_OutSide extends StatefulWidget{
  ...
  Baneficiary_List_OutSide(String acc_no, String accountName, bool is_transfer){
    this.acc_no=acc_no;
...
class Build_State extends State<Baneficiary_List_OutSide>{
  ...
  _getAccountDetails(BuildContext context) async {
    await FireBase_Logs().log_screen_view("Add Banefeciary Outside", "Add Banefeciary Outside");
