...
class Baneficiary_List extends StatefulWidget{
  ...
  Baneficiary_List(String acc_no, String accountName, bool is_transfer){
    this.acc_no=acc_no;
...
class Build_State extends State<Baneficiary_List>{
  ...
  Widget build(BuildContext context) {
    ...
    return new
    Scaffold(
      appBar: AppUtils.appBarTitle(context,"Benefeciary Account"),
         ...
         _isLoading==true?Center(child: new CircularProgressIndicator(),):new SingleChildScrollView(
           child:new Column(
             ...
             children: [
               ...
               if(beneficiary_list.length==0)Center(child: No_Data_Placeholder_add("No Beneficiary Account Added..!!","Add Beneficiary",add: (){
                 Navigator.of(context).push(MaterialPageRoute(builder: (context) => Add_Baneficiary(widget.acc_no)));
  ...
  _getAccountDetails(BuildContext context) async {
   await FireBase_Logs().log_screen_view("View Banefeciary List", "View Banefeciary List");
