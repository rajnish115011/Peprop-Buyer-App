...
class For_Availability extends StatefulWidget {

  List<Availability_Model>reportList;
  final Function(Availability_Model) onSelectionChanged;
  For_Availability(this.reportList, {required this.onSelectionChanged});
  @override
  _MultiSelectChipState createState() => _MultiSelectChipState();
}
class _MultiSelectChipState extends State<For_Availability> {
