...
class Furnishing_Sheet extends StatefulWidget {

  List<Furnishing_Model>reportList;
  final Function(Furnishing_Model) onSelectionChanged;
  Furnishing_Sheet(this.reportList, {required this.onSelectionChanged});
  @override
  _MultiSelectChipState createState() => _MultiSelectChipState();
}
class _MultiSelectChipState extends State<Furnishing_Sheet> {
