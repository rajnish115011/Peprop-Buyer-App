...
class Search_Property_Buy extends StatefulWidget{

  String city="";
  int filter_type=1;

  Search_Property_Buy(String city, int filter_type){
    this.city=city;
...
class Build_Widget  extends State<Search_Property_Buy>{
        ...
        new Stack(
          children: [
            ...
            if(loading==false&&search.text.length>2&&list.length==0)Center(
                ...
                InkWell(
                  onTap: (){
                    Search_Model model=new Search_Model(id: "0", builder_name: "", property_name: search.text.toString(),property_type: "",location: "",city: "",PropertyTitle: "",Address: "");
