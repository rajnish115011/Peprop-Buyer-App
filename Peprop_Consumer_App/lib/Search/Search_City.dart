...
class Build_Widget extends State {
                            ...
                            child: new Container(
                              ...
                              child: new GestureDetector(
                                child: new Column(
                                  ...
                                  children: [
                                    new Text(
                                      list[index].city_name +
                                          "," +
                                          list[index].state_name +
                                          " (" +
                                          list[index].country_name +
                                          ")",
                                      style: new TextStyle(
  ...
  get_properties(String value) {
    ...
    ServiceConfig()
        .postApiBodyAuthJson(API.city_search, formData, context)
        .then((value) {
      ...
      if (response != null && response.statusCode == 200) {
        ...
        list = notify
            .map<City_Model>((json) => City_Model.fromJson(json))
            .toList();
        setState(() {
          loading = false;
        });
