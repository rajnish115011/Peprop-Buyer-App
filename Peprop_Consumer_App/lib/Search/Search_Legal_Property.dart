...
class Search_Legal_Property extends StatefulWidget{
...
class Build_Widget  extends State<Search_Legal_Property>{
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (BuildContext con,int index){
                ...
                InkWell(
                  onTap: (){
                    Navigator.pop(context,list[index].PropertyTitle);
                        ...
                        Expanded(child: new Container(
                          ...
                          new GestureDetector(
                            ...
                            child: new Column(
                              ...
                              children: [
                                new Text(list[index].PropertyTitle.toString()+" ("+list[index].Address.toString()+")",style: new TextStyle(fontSize: 13,fontFamily: "regular"),maxLines: 2,overflow: TextOverflow.ellipsis,),
                              ],
                            ),
                          ),))
                      ],
            ...
            if(loading==false&&search.text.length>2&&list.length==0)Center(
                child:
                InkWell(
                  onTap: (){
                    Navigator.pop(context,search.text.toString());
                  ...
                  child: new Container(
                    ...
                    child: new Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                        new Text("Can't find in suggestions? ",style: new TextStyle(fontFamily: "regular",fontSize: 13,color: ColorFile.black),),
                        new Text("Click here to add",style: new TextStyle(fontFamily: "bold",fontSize: 13,color: ColorFile.app_color),),
  ...
  get_properties(String value) {
    ...
    ServiceConfig()
        .postApiBodyAuthJson(API.seacrhPropertyLists,formData, context)
        .then((value) {
